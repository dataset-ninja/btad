...
GITHUB_URL: str = "https://github.com/dataset-ninja/btad"
# URL to GitHub repo on dataset ninja (e.g. "https://github.com/dataset-ninja/some-dataset")

##################################
### * Optional after uploading ###
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = "https://www.kaggle.com/datasets/thtuan/btad-beantech-anomaly-detection/download?datasetVersionNumber=1"
...
SLYTAGSPLIT: Optional[Dict[str, Union[List[str], str]]] = {"image sets":['ok','ko']}
